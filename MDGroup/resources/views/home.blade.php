...
<body>
    <header id="home">
        <nav class="navbar navbar-expand-lg navbar-fixed-js">
            <div class="main-brand">
                ...
                <button class="navbar-toggler  border-0 hamburger hamburger--elastic btn-xs " data-toggle="offcanvas" type="button">
    ...
    <div class="wrapper">
        <div class="slider-banner">
            {{--<div><img src="{{ url('assets/img/banner (4).png') }}">
        </div>
    ...
    <section id="">
        ...
        <!----<div class="slider-promise">
            ...
            <div class="md-abrodad" style="background:url('assets/img/bannersection2.jpg')" id="md">
                <div class="md-abrodad_item container" data-aos="zoom-in" data-aos-duration="2500">
                    <img src="{{ url('assets/img/logoblue.png') }}" alt="">
            ...
            <div class="main-services_content">
                ...
                <div class="ml-5">
                    ...
                    <p>• Access to legal counsel whenever the traveler is being<br>
                        ...
                        <b style="color: transparent;">• </b>consular authorities locally.
                    </p>
    ...
    <section class="services- mt-5 position-relative" id="levels">
        ...
        <div class="container services-level" data-aos="zoom-in">
            ...
            <div class="level-item">
                ...
                <div class="level-item_two level-custom_sla5">
                    <p>
                        Response < 7 days of receipt of full documentation </p>
                </div>
            </div>
            <div class="level-item">
                <div class="level-item_one">
